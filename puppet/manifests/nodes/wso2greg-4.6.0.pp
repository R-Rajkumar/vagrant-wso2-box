...
node /wso2greg-4.6.0/ inherits base {
  ...
  class { 'wso2greg':
	...
	"CONFIG_PARAM_LOCAL_REGISTRY_DB_URL=jdbc:mysql://localhost:3306/mbie_registry?autoReconnect=true",
	"CONFIG_PARAM_LOCAL_REGISTRY_DB_USER_NAME=root",
	"CONFIG_PARAM_LOCAL_REGISTRY_DB_PASSWORD=root",
	"CONFIG_PARAM_USER_MGT_DB_URL=jdbc:mysql://localhost:3306/mbie_userdb",
